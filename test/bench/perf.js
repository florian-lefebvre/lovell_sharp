...
async.series(
  {
    ...
    // PNG
    png: (callback) => {
      const inputPngBuffer = fs.readFileSync(
        fixtures.inputPngAlphaPremultiplicationLarge
      );
