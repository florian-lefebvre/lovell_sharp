...
function isInAcceptableRange(actual, expected) {
  return (
    actual >= (1 - threshold) * expected && actual <= (1 + threshold) * expected
  );
}
...
suite('Image Stats', () => {
  test('JPEG', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.entropy, 7.332915340666659)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.sharpness, 0.7883011147075762)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].sum, 615101275)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].squaresSum, 83061892917)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].mean, 101.44954540768993)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].stdev, 58.373870588815414)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].sum, 462824115)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].squaresSum, 47083677255)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].mean, 76.33425255128337)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].stdev, 44.03023262954866)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].sum, 372986756)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].squaresSum, 32151543524)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].mean, 61.51724663436759)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].stdev, 38.96702865090125)
    );
  ...
  test('PNG without transparency', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.entropy, 0.3409031108021736)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.sharpness, 9.111356137722868)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].sum, 1391368230)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].squaresSum, 354798898650)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].mean, 238.8259925648822)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].stdev, 62.15121915523771)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[0].minX));
  ...
  test('PNG with transparency', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.entropy, 0.06778064835816622)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.sharpness, 2.522916068931278)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].sum, 795678795)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].squaresSum, 202898092725)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].mean, 252.9394769668579)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].stdev, 22.829537532816)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[0].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].sum, 795678795)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].squaresSum, 202898092725)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].mean, 252.9394769668579)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].stdev, 22.829537532816)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[1].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].sum, 795678795)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].squaresSum, 202898092725)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].mean, 252.9394769668579)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].stdev, 22.829537532816)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[2].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].sum, 5549142)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].squaresSum, 1333571132)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].mean, 1.7640247344970703)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].stdev, 20.51387814157297)
    );
  ...
  test('PNG fully transparent', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].squaresSum, 0)
    );
  ...
  test('TIFF', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.entropy, 0.3851250782608986)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.sharpness, 10.312521863719589)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].sum, 1887266220)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].squaresSum, 481252886100)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].mean, 235.81772349417824)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].stdev, 67.25712856093298)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[0].minX));
  ...
  test('WebP', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.entropy, 7.51758075132966)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.sharpness, 9.971384105278734)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].sum, 83291370)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].squaresSum, 11379783198)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].mean, 105.36169496842616)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].stdev, 57.39412151419967)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[0].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].sum, 120877425)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].squaresSum, 20774687595)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].mean, 152.9072025279307)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].stdev, 53.84143349689916)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[1].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].sum, 138938859)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].squaresSum, 28449125593)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].mean, 175.75450711423252)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].stdev, 71.39929031070358)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[2].minX));
  ...
  test('GIF', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.entropy, 6.08118048729375)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.sharpness, 2.936767879098001)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].sum, 56088385)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].squaresSum, 8002132113)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].mean, 131.53936444652908)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].stdev, 38.26389131415863)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[0].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].sum, 58612156)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].squaresSum, 8548344254)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].mean, 137.45815196998123)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[1].stdev, 33.955424103758205)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[1].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].sum, 49628525)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].squaresSum, 6450556071)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].mean, 116.38959896810506)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[2].stdev, 39.7669551046809)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[2].minX));
  ...
  test('Grayscale GIF with alpha', async (t) => {
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.sharpness, 15.870619016486861)
    );
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].squaresSum, 10201)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].mean, 50.5)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[0].stdev, 71.4177848998413)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[0].minX));
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].squaresSum, 65025)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].mean, 127.5)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(stats.channels[3].stdev, 180.31222920256963)
    );
    t.assert.strictEqual(true, isInteger(stats.channels[3].minX));
  ...
  test('Stream in, Callback out', (t, done) => {
    ...
    pipeline.stats((err, stats) => {
      ...
      t.assert.strictEqual(
        true,
        isInAcceptableRange(stats.sharpness, 0.788301114707569)
      );
  ...
  test('Blurred image has lower sharpness than original', async (t) => {
    ...
    const blurred = sharp(fixtures.inputJpg)
      .blur()
      .toBuffer()
      .then((blur) => sharp(blur).stats());
    ...
    t.assert.strictEqual(
      true,
      isInAcceptableRange(originalStats.sharpness, 0.789046400439488)
    );
    t.assert.strictEqual(
      true,
      isInAcceptableRange(blurredStats.sharpness, 0.47985138441709047)
    );
  });
  ...
  test('Sequential read option is ignored', async (t) => {
    t.plan(1);
    const { isOpaque } = await sharp(fixtures.inputJpg, {
      sequentialRead: true
    }).stats();
